...
export const familyBookings = {
  ...
  "2026-08-14": {
    ...
    s:{
      m:["Flight 9:15am"],
      a:["Arrive 1:45pm","Walmart / Target"],
      e:["Chili's / Cheesecake Factory"]
    }
  },
  ...
  "2026-08-25": {
    ...
    s:{
      m:[],
      a:[],
      e:["Be Our Guest 5:30pm"]
    }
  },

  "2026-08-26": {
    p:{
      m:["Leo's first haircut"],
      a:[],
      e:["Wailulu Grill"]
    },
    s:{
  ...
  "2026-08-31": {
    p:{
      m:["Keke's / First Watch"],
      a:[],
      e:[]
    },
    s:{
      m:["Disembark"],
      a:["Hollywood Studios → EPCOT"],
      e:["Eat to the Beat"]
    }
  },
