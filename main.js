...
function header(){return `<header class="hero"><div class="heroTop"><span class="tag">✨ 🏰 Orlando 2026</span><div class="avatars"><span class="avatar p">P</span><span class="avatar s">S</span></div></div><h1><span class="magicO">O</span>rlando</h1><div class="sub">Peterborough Jacksons + St Helens Jacksons</div><div class="dates">📅 14 August – 3 September 2026</div></header>`}
